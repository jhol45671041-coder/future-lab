...
/** Thin diagonal arrow pointing to the top-right. */
...
/** Clock with hands at roughly 12:15. */
...
export function GlobeIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 3a9.6 9.6 0 0 0 0 18" />
    </svg>
  );
}

/** Filled Material-style image icon. */
...
/** Filled Material-style movie / clapboard icon. */
export function MovieIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="24"
...
/** Filled Material-style lightbulb icon. */
